...
const categories = <CategoryItem>[
  ...
  CategoryItem('transport_fuel', 'Fuel', Icons.local_gas_station, Color(0xFF66BB6A)),
  ...
  CategoryItem('salary', 'Salary', Icons.account_balance, Color(0xFF4CAF50)),
  CategoryItem('freelance', 'Freelance', Icons.work, Color(0xFF26A69A)),
  CategoryItem('investment', 'Investment', Icons.trending_up, Color(0xFF009688)),
  CategoryItem('rent', 'Rent', Icons.home, Color(0xFF795548)),
  CategoryItem('emi', 'EMI', Icons.credit_card, Color(0xFF8D6E63)),
  CategoryItem('subscription', 'Subscription', Icons.subscriptions, Color(0xFF7E57C2)),
  ...
  CategoryItem('gifts', 'Gifts', Icons.card_giftcard, Color(0xFFFFD54F)),
  CategoryItem('other', 'Other', Icons.more_horiz, Color(0xFF9E9E9E)),
];
